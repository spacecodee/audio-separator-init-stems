...
AUDIO="${AUDIO:-${VOCALS_MALE_FEMALE_AUDIO:-${DEFAULT_AUDIO:-/teamspace/studios/this_studio/audio/Audio03.wav}}}"
EXTRACT_MODEL="${EXTRACT_MODEL:-${VOCALS_MALE_FEMALE_EXTRACT_MODEL:-mel_roformer}}"
SPLIT_MODEL="${SPLIT_MODEL:-${VOCALS_MALE_FEMALE_SPLIT_MODEL:-chorus_male_female}}"
...
JOB_RESPONSE="$(curl -sS -X POST "$BASE/separate/vocals/male-female" \
  -F "file=@$AUDIO" \
